...
CREATE TABLE PROFESOR_TUTOR(
    COD_DOCENTE NUMBER REFERENCES PROFESORES PRIMARY KEY,
...
CREATE TABLE SECCION(
    ...
    COD_ALUMNO NUMBER REFERENCES ALUMNO,
    COD_DOCENTE NUMBER REFERENCES PROFESOR_TUTOR
);
-- HABILITADOS DE PROFESOR_TUTOR
-- ERROR PORQUE NO DEBEN EXISTIR COINCIDENCIAS EN PK, CUANDO SE USA SELECT SOLO APARECE UN SALON ROJO
-- PROFESOR 20101001
