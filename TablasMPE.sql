...
INSERT INTO USUARIO VALUES(30101001, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '911743338', 'EVELIN','JIMENEZ','ROSA','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101002, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '973024716', 'PEDRO','AGUILAR','DEL MONTE','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101003, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '93389578', 'LUIS','SOSA','AGUILAR','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101004, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '944167552', 'ANDREA','NINA','PEREZ','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101005, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '943641658', 'IRMA','CORTEZ','CERVATES','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101006, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '996580867', 'ROMINA','LOPEZ','AGUIRRE','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '981422966', 'ANGEL','TORRES','PENA','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '923142469', 'FRANCISCO','SAAVEDRA','PENA','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '977070027', 'MANUEL','PARIONA','IDELFONSO','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '996766219', 'ALONSO','CARRERA','CHAN','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '974078778', 'JULIAN','CABRERA','OVIEDO','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '945169072', 'DIANA','CASTILLO','MANNUCCI','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '998532250', 'ALONSO','ARCOS','QUISPE','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '967716112', 'LEONARDO','ESPIRITU','ALVAREZ','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '933983369', 'FERNANDO','SALAVERRY','BENITES','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '981287480', 'MIGUEL','SIALER','CASTRO','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '995409504', 'ANTONIA','OLASABAL','CONTRERAS','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '910930597', 'JULIA','CATERIANO','GONZALES','HOLAMUNDO3');
INSERT INTO USUARIO VALUES(30101007, TO_DATE('30/03/2001', 'DD/MM/YYYY'), 'ALUMNO', '942268583', 'JENNY','ALBUJAR','DUARTE','HOLAMUNDO3');
...
INSERT INTO ALUMNO VALUES(30101001,1,'EVELIN JIMENEZ',3961082,'
Juan Alberto Pereira Camacaro ');
INSERT INTO ALUMNO VALUES(30101002,2,'PEDRO AGUILAR DEL MONTE',3944201,'Williams Avelino Orozco cruz
');
INSERT INTO ALUMNO VALUES(30101003,3,'LUIS SOSA AGUILAR',7707749,'Gino Jesús Flores Baca ');
INSERT INTO ALUMNO VALUES(30101004,4,'ANDREA NINA PEREZ',3648273,'Luis Denilson Barreto Nuñez');
INSERT INTO ALUMNO VALUES(30101005,5,'IRMA CORTEZ CERVATES',5553365,'Willians walther cornejo Garcia ');
INSERT INTO ALUMNO VALUES(30101006,6,'ROMINA LOPEZ AGUIRRE',08060412,'"
Bertha Patricia Paz Romero"');
INSERT INTO ALUMNO VALUES(30101006,7,'ANGEL TORRES PENA',5237272,'Diana Vanessa Caballero Meza ');
INSERT INTO ALUMNO VALUES(30101007,8,'FRANCISCO SAAVEDRA PENA',3620115,'ROXANA DIAZ ARONI');
INSERT INTO ALUMNO VALUES(30101008,9,'MANUEL PARIONA IDELFONSO',5111948,'Antonio Jose Antoniete Calderon');
INSERT INTO ALUMNO VALUES(30101009,10,'ALONSO CARRERA CHAN',8406598,'Romy Mariel Merejildo Acevedo');
INSERT INTO ALUMNO VALUES(30101010,11,'JULIAN CABRERA OVIEDO',2024605,'Benigna Olga Ipince Martínez ');
INSERT INTO ALUMNO VALUES(30101011,12,'DIANA CASTILLO MANUCCI',5285520,'Rita Soledad Hernández Aguilar ');
INSERT INTO ALUMNO VALUES(30101012,13,'ALONSO ARCOS QUISPE',9544199,'Lorenzo Humberto Minaya Zavaleta');
INSERT INTO ALUMNO VALUES(30101013,14,'LEONARDO ESPIRITU ALVAREZ',1068786,'Contreras Moncada Giovanna ');
INSERT INTO ALUMNO VALUES(30101014,15,'FERNANDO SALAVERRY BENITES',4044737,'Maribel Seira Ramos Martinez ');
INSERT INTO ALUMNO VALUES(30101015,16,'MIGUEL SIALER CASTRO',4358063,'Sindy Aranda Castillo');
INSERT INTO ALUMNO VALUES(30101016,17,'ANTONIA OLASABAL CONTRERAS',3170911,'Margarita Ana Vicente Cárdenas ');
INSERT INTO ALUMNO VALUES(30101017,18,'JULIA CATERIANO GONZALES',2850030,'Charo Rocío Chahuara Telles');
INSERT INTO ALUMNO VALUES(30101018,19,'JENNY ALBUJAR DUARTE',5007260,'Marisa Esperanza Flores Angulo');


SELECT * FROM USUARIO U INNER JOIN ALUMNO Q ON U.DNI = Q.COD_ALUMNO WHERE COD_ALUMNO = 30101001; 
SELECT * FROM ALUMNO WHERE COD_ALUMNO = 30101001;
